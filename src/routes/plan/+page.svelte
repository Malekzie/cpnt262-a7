...
<section class="h-screen pl-5 pt-36 back">
    <div class="mx-auto bg-white bg-opacity-25 cursor-default dark:bg-black dark:bg-opacity-30 ">
        ...
        <p class="m-5 mt-5 text-xl link-face">The Dragon Sanctuary is open 24/7, 365 days a year. Our Magic Circles are specifically curated to be able to recieve transportation wherever you are located. We have lodgings for those who chose to remain for more than a days visit.</p>
    </div>
    <div>
        <div class="flex justify-around mt-16">
            <!-- Modals will be used for this one -->
            <CtaButtons ctaDescription="Book a Tour" link="/book" />
